      ...
      <div className="helloMain">
        <div className="relative z-10">
          <div className="flex flex-col items-center mb-10 sm:mb-6">
            <h1 className="text-[20vw] xl:text-9xl font-gochi-hand pb-6 sm:pb-0">I&apos;m Mochi</h1>
            <div className="flex flex-col xl:flex-row gap-[12px] sm:gap-4 md:gap-3 xl:gap-2 align-middle *:font-alegreya-medium *:text-4xl *:sm:text-3xl *:md:text-4xl *:xl:text-2xl justify-center xl:justify-normal text-center xl:text-left">
          ...
          <div className="flex flex-col items-center mx-auto">
            <img
              src="./bnu.webp"
              className="rounded-xl w-[95%] sm:w-[90%] md:w-[75%] lg:w-[65%] xl:w-[40%] 2xl:w-[30%] select-none pointer-events-none"
              width="1733px"
              height="1155px"
              alt="A bunny rabbit."
            />
            ...
            <div className="w-11/12 lg:w-10/12 xl:w-7/12 2xl:w-6/12 mx-auto *:mb-5 mt-4">
              <div>
