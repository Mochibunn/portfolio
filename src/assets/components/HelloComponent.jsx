      ...
      <div className="helloMain">
        <div className="relative z-10">
          <div className="flex flex-col items-center mb-10 sm:mb-6">
            ...
            <div className="flex flex-col xl:flex-row gap-[12px] sm:gap-4 md:gap-3 xl:gap-2 align-middle *:font-alegreya-medium *:text-xl *:sm:text-3xl *:md:text-xl *:xl:text-2xl justify-center xl:justify-normal text-center xl:text-left">
          ...
          <div className="flex flex-col items-center mx-auto">
            <img
              src="./bnu.webp"
              className="rounded-xl w-[85%] sm:w-[70%] md:w-[55%] lg:w-[50%] xl:w-[40%] 2xl:w-[30%] select-none pointer-events-none"
              width="1733px"
              height="1155px"
              alt="A bunny rabbit."
            />
            ...
            <div className="w-10/12 sm:w-10/12 md:w-8/12 lg:w-8/12 xl:w-7/12 2xl:w-6/12 mx-auto *:mb-5 mt-4">
              <div>
