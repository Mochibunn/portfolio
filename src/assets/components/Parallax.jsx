    ...
    <div className="relative">
      ...
      >
        <motion.h1
          ...
          className={`-top-[100px] sm:-top-[250px] 2xl:-top-[50px] text-[15vw] 2xl:text-[10vw] font-oleo font-bold select-none pointer-events-none text-star relative z-10 bottom-0`}
        >
          Hello!
        </motion.h1>
