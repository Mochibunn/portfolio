...
const classList = {
  ...
  stackSubheadingClasses: "lg:text-base xl:text-2xl 2xl:text-3xl font-alegreya-medium w-fit",
  topCardClasses: "flex md:flex-row w-11/12 2xl:w-10/12 py-6 lg:p-6 xl:p-12 justify-center items-center sm:items-stretch sm:justify-stretch md:justify-evenly rounded-2xl relative",
