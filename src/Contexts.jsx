...
const classList = {
  ...
  topCardClasses: "flex md:flex-row w-10/12 p-6 xl:p-12 justify-center items-center md:items-stretch md:justify-stretch xl:justify-evenly rounded-2xl relative",
